...
*/
    {
      title: "Level App - Wallet Digitale per Fumetteria",
      description: "Level App è una Progressive Web App realizzata per Level Up, fumetteria di fiducia, per digitalizzare buoni, crediti e fidelizzazione clienti. L'obiettivo era sostituire i buoni cartacei con un wallet virtuale installabile sullo smartphone, utilizzabile al bancone e dai clienti in autonomia.\n\nL'ecosistema comprende un'area cliente (saldo, storico movimenti, eventi del negozio, notifiche push) e un pannello admin completo per il personale: creazione buoni, cassa/scarico credito, anagrafica clienti, statistiche, gestione eventi e operazioni di storno.\n\n✨ Funzionalità Principali\n- Wallet Virtuale & Buoni Digitali: credito scalabile, barcode cliente e storico transazioni in tempo reale.\n- Pannello Admin Negozio: workflow bancone (cassa), creazione buoni con causali/preset, ricerca clienti e diagnostica operativa.\n- Eventi & Push Notifications: calendario eventi TCG/fumetti con reminder automatici e notifiche Web Push.\n- Auth & Privacy: autenticazione Supabase, recupero password, privacy policy e flusso GDPR di anonimizzazione account.\n- PWA Installabile: manifest, service worker e UX mobile-first pensata per uso quotidiano in negozio e a casa.\n- Stack Cloud: Next.js su Vercel, database/auth Supabase, cron per backup e reminder eventi.\n\n*Progetto live in produzione per la fumetteria Level Up.*",
      image: "/projects/level-app.png",
      slug: "level-app",
      technologies: ["Next.js", "TypeScript", "Supabase", "Tailwind CSS", "PWA", "Web Push", "Vercel"],
